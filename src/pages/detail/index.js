...
export function Detail(){
    ...
    useLayoutEffect(() => {
        ...
        navigation.setOptions({
            ...
            headerRight: () => (
                <Pressable onPress={ () => handleFavoriteRececipe(route.params?.data) }>
                    { favorite ? (
                        <Entypo 
                            name="heart"
                            size={28}
   ...
   async function handleFavoriteRececipe(receipe){
        if(favorite){
    ...
    return(
        <ScrollView scontentContainerStyle={{ paddingBotton: 14 }} style={styles.container} showsVerticalScrollIndicator={false}>
            ...
            <Modal visible={showVideo} animationType='slide'>
                <VideoView 
                    heandleClose={ () => setShowVideo(false)}
